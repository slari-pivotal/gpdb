...
public class query05 {
  ...
  Statement s = null;
    ...
    try {
      ...
      m = s.executeUpdate("create table aoco_tbl(a int, b int) WITH (appendonly=true,orientation=column,compresstype=quicklz,compresslevel=1,blocksize=32768) distributed by (a)");

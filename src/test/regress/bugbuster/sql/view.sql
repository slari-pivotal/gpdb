\c regression
set test_enable_broken_quicklz3=on;
...
create table T20(	C233 int,	C234 int,	C235 int,	C236 int,	C237 int,	C238 int,	C239 int,	C240 int,	C241 int,	C242 int,	C243 int,	C244 int,	C245 int,	C246 int) WITH (compresstype=quicklz,blocksize=229376,appendonly=true,compresslevel=1,checksum=true);
...
create table T29(	C334 int,	C335 int,	C336 int,	C337 int,	C338 int,	C339 int,	C340 int) WITH (compresstype=quicklz,checksum=true,appendonly=true,blocksize=1155072,compresslevel=3);
...
create table T34(	C402 int,	C403 int,	C404 int,	C405 int,	C406 int,	C407 int,	C408 int,	C409 int,	C410 int) WITH (compresstype=quicklz,compresslevel=1,appendonly=true,blocksize=1318912);
...
create table T43(	C487 int,	C488 int,	C489 int,	C490 int,	C491 int,	C492 int,	C493 int,	C494 int,	C495 int,	C496 int,	C497 int,	C498 int,	C499 int,	C500 int,	C501 int) WITH (compresstype=quicklz,compresslevel=1,appendonly=true,blocksize=1327104,checksum=true);
...
create table T44(	C502 int,	C503 int,	C504 int,	C505 int,	C506 int,	C507 int,	C508 int,	C509 int,	C510 int,	C511 int) WITH (compresstype=quicklz,compresslevel=1,appendonly=true,blocksize=1703936,checksum=true);
...
create table T52(	C625 int,	C626 int,	C627 int,	C628 int,	C629 int,	C630 int,	C631 int,	C632 int,	C633 int,	C634 int,	C635 int) WITH (compresstype=quicklz,blocksize=2031616,appendonly=true,compresslevel=1);
...
create table T53(	C636 int,	C637 int,	C638 int,	C639 int,	C640 int,	C641 int,	C642 int,	C643 int,	C644 int,	C645 int,	C646 int,	C647 int,	C648 int,	C649 int,	C650 int,	C651 int,	C652 int,	C653 int) WITH (compresstype=quicklz,compresslevel=3,appendonly=true,blocksize=491520);
...
create table T60(	C717 int,	C718 int,	C719 int,	C720 int,	C721 int,	C722 int,	C723 int,	C724 int) WITH (compresstype=quicklz,compresslevel=1,appendonly=true,blocksize=1433600);
...
create table T76(	C938 int,	C939 int,	C940 int,	C941 int,	C942 int,	C943 int,	C944 int,	C945 int,	C946 int) WITH (compresstype=quicklz,checksum=false,appendonly=true,blocksize=491520,compresslevel=3);

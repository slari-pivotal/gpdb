...
class ArchitectureSpecificTemplateManager:
    ...
    #
        ...
        for archLine in readAllLinesFromFile(os.path.dirname(os.path.abspath(__file__)) + "/arch_config", stripLines=True, skipEmptyLines=True):

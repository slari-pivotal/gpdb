...
-- MPP-16174
drop external table if exists equifax_load;
create readable external table equifax_load (
    address varchar(46),
    state varchar(2),
    zipcode int,
    id int,
...
LOCATION ('file://localhost/data/equifax_temp/rB8C3A14_FRB_031999_01.dat')

...
'select $1' LANGUAGE SQL CONTAINS SQL;
...
'select $1 || $2' LANGUAGE SQL CONTAINS SQL;
...
'select $1+$2+$3' language sql strict CONTAINS SQL;
...
select case when $1 then $2 else $3 end $$ language sql CONTAINS SQL;

...
explain UPDATE update_test t SET b = t.b + 10 WHERE t.a = 10;
UPDATE update_test t SET b = t.b + 10 WHERE t.a = 10;
SELECT a,b,c FROM update_test ORDER BY a,b;


explain UPDATE update_test SET a=v.i FROM (VALUES(100, 20)) AS v(i, j)
...
explain UPDATE t1 SET data2 = t2.data2 FROM t2 WHERE t1.data1 = t2.data1;

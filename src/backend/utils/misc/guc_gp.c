...
struct config_int ConfigureNamesInt_gp[] =
{
	...
	{
		{"gp_diskusage_hard_limit", PGC_USERSET, GP_ARRAY_TUNING,
			gettext_noop("Percentage value of disk consumption at which to shutdown the database."),
			NULL,
			GUC_NOT_IN_SAMPLE
		},
		&gp_diskusage_hard_limit,
		95, 0, 100, NULL, NULL
	},

...
Feature: gpfdist configure timeout value
    ...
    Scenario: gpfdist wait some time before close file - simple
        Given the "gpfdist" process is killed
        Given the client program "gpfdist_httpclient.py" is present under CWD in "test/behave_utils/gpfdist_utils"
        Given the directory "extdata" exists in current working directory
        ...
        When the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=2 --segment_index=0" from "test/behave_utils/gpfdist_utils" under CWD
        And  the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=2 --segment_index=0 --isdone" from "test/behave_utils/gpfdist_utils" under CWD
        Given waiting "1" seconds
        Then the file "./extdata/data.txt" by process "extdata/gpfdist.pid" is not closed

        When the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=2 --segment_index=1" from "test/behave_utils/gpfdist_utils" under CWD
        And  the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=2 --segment_index=1 --isdone" from "test/behave_utils/gpfdist_utils" under CWD
    ...
    Scenario: gpfdist wait some time before close file - multi session
        ...
        When the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=2 --segment_index=0 --session_id=1" from "test/behave_utils/gpfdist_utils" under CWD
        And  the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=2 --segment_index=0 --session_id=1 --isdone" from "test/behave_utils/gpfdist_utils" under CWD
        Given waiting "1" seconds
        Then the file "./extdata/data.txt" by process "extdata/gpfdist.pid" is not closed

        When the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=2 --segment_index=1 --session_id=2" from "test/behave_utils/gpfdist_utils" under CWD
        And  the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=2 --segment_index=1 --session_id=2 --isdone" from "test/behave_utils/gpfdist_utils" under CWD
    ...
    Scenario: gpfdist wait some time before close file - more segments
        ...
        # seg0 send data
        When the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=8 --segment_index=0 --session_id=1" from "test/behave_utils/gpfdist_utils" under CWD
        # seg1 send data
        And the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=8 --segment_index=1 --session_id=1" from "test/behave_utils/gpfdist_utils" under CWD
        # seg1 send done
        And  the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=8 --segment_index=1 --session_id=1 --isdone" from "test/behave_utils/gpfdist_utils" under CWD
        # seg0 send done
        And  the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=8 --segment_index=0 --session_id=1 --isdone" from "test/behave_utils/gpfdist_utils" under CWD

        Given waiting "1" seconds
        Then the file "./extdata/data.txt" by process "extdata/gpfdist.pid" is not closed

        # seg2 send data
        When the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=8 --segment_index=2 --session_id=1" from "test/behave_utils/gpfdist_utils" under CWD
        # seg3 send data
        When the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=8 --segment_index=3 --session_id=1" from "test/behave_utils/gpfdist_utils" under CWD
        # seg2 send done
        And  the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=8 --segment_index=2 --session_id=1 --isdone" from "test/behave_utils/gpfdist_utils" under CWD
        # seg3 send done
        And  the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=8 --segment_index=3 --session_id=1 --isdone" from "test/behave_utils/gpfdist_utils" under CWD

        Given waiting "1" seconds
        Then the file "./extdata/data.txt" by process "extdata/gpfdist.pid" is not closed

        # seg4 send data
        When the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=8 --segment_index=4 --session_id=1" from "test/behave_utils/gpfdist_utils" under CWD
        # seg4 send done
        And  the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=8 --segment_index=4 --session_id=1 --isdone" from "test/behave_utils/gpfdist_utils" under CWD
    ...
    Scenario: gpfdist works when using sequence_number and avoid duplicated writes
        ...
        And the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=2 --segment_index=0 --session_id=1 --sequence_num=2 --data=1234" from "test/behave_utils/gpfdist_utils" under CWD
        And the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=2 --segment_index=0 --session_id=1 --sequence_num=2 --data=1234" from "test/behave_utils/gpfdist_utils" under CWD
        And the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=2 --segment_index=0 --session_id=1 --sequence_num=2 --isdone" from "test/behave_utils/gpfdist_utils" under CWD
        Given waiting "4" seconds
    ...
    Scenario: gpfdist works when using sequence_number and avoid duplicated writes
        ...
        Given the directory "extdata" exists in current working directory
        When the user runs "gpfdist -p 8088 -V -l ./gpfdist.log -d extdata -w 3 & echo $! > extdata/gpfdist.pid &"
        And the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=2 --segment_index=0 --session_id=1 --data='1234'" from "test/behave_utils/gpfdist_utils" under CWD
        And the user runs client program "gpfdist_httpclient.py --url=localhost:8088 --path=/data.txt --segment_count=2 --segment_index=0 --session_id=1 --isdone" from "test/behave_utils/gpfdist_utils" under CWD
        Given waiting "4" seconds
        When the user runs command "wc -l ./extdata/data.txt"
        Then the file "extdata/data.txt" by process "extdata/gpfdist.pid" is closed
    ...
    Scenario: gpfdist should reject bad encoded EOL
        Given the client program "fake_url.py" is present under CWD in "test/behave_utils/gpfdist_utils"
        Given the directory "extdata" exists in current working directory
        Given the "gpfdist" process is killed
        ...
        And the user runs client program "fake_url.py -u 'localhost:8088/demo' -H extdata/open" from "test/behave_utils/gpfdist_utils" under CWD
    ...
    Scenario: gpfdist should reject bad encoded EOL
        Given the client program "gpfdist_specialrequest.py" is present under CWD in "test/behave_utils/gpfdist_utils"
        Given the directory "extdata" exists in current working directory
        Given the "gpfdist" process is killed
        And the user runs "gpfdist -p 8088 -V > ./gpfdist.log & "
        When the user runs client program "gpfdist_specialrequest.py" from "test/behave_utils/gpfdist_utils" under CWD
        Given waiting "2" seconds
        When the "gpfdist" process is killed
        And the user runs command "cat ./gpfdist.log"

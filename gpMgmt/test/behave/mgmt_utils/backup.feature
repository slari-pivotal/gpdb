...
Feature: Validate command line arguments
    ...
    Scenario: Incremental Backup and Redirected Restore
        ...
        And the user runs "gpdbrestore --redirect=bkdb2 -e -a" with the stored timestamp
        Then gpdbrestore should return a return code of 0
        And verify that the data of "11" tables is the same in "bkdb2" as in "bkdb" after restore
    ...
    Scenario: Full backup and redirected restore with -T
        ...
        And gpdbrestore should return a return code of 0
        And verify that the data in the "ao" table "public.ao_index_table" is the same in "bkdb2" as in "bkdb"
    ...
    Scenario: Incremental redirected restore with table filter
        ...
        Then gpdbrestore should return a return code of 0
        And verify that the data of "2" tables is the same in "bkdb2" as in "bkdb" after restore
    ...
    Scenario: Full Backup and Redirected Restore with --prefix option for multiple databases
        ...
        And gpdbrestore should return a return code of 0
        And there should be dump files under " " with prefix "foo"
        And verify that the data in the "heap" table "public.heap_table" is the same in "bkdb3" as in "bkdb"
        And verify that the data in the "ao" table "public.ao_part_table" is the same in "bkdb3" as in "bkdb"

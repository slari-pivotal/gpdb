...
def before_feature(context, feature):
    ...
    if 'minirepro' in feature.tags:
        ...
        dbconn.execSQL(context.conn, "CREATE OR REPLACE FUNCTION gp_toolkit.gp_dump_query(text) " \
        "RETURNS text AS '$libdir/gpoptutils', 'gp_dump_query' LANGUAGE C IMMUTABLE;")
        dbconn.execSQL(context.conn, 'GRANT EXECUTE ON FUNCTION gp_toolkit.gp_dump_query(text) TO public')

...
sync_tools: opt_write_test /opt/releng/apache-ant
	...
	$(BLD_WHERE_THE_LIBRARY_THINGS_ARE)="" wget -O - https://github.com/greenplum-db/gporca/releases/download/v2.40.0/bin_orca_centos5_release.tar.gz | tar zxf - -C $(BLD_TOP)/ext/$(BLD_ARCH)

...
function gen_env(){
	...
	chown gpadmin:gpadmin /home/gpadmin/build_s3_components.sh
	chmod a+x /home/gpadmin/build_s3_components.sh
}
...
function build_s3_components() {
	su - gpadmin -c "bash /home/gpadmin/build_s3_components.sh $(pwd)"
}
...
function push_to_staging_server() {
	...
	scp -i /home/gpadmin/ec2_private_key -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null gpdb_src/gpAux/extensions/gps3ext/bin/gpcheckcloud/gpcheckcloud gpadmin@$EC2_INSTANCE_IP:/home/gpadmin/greenplum-db/bin/
	scp -i /home/gpadmin/ec2_private_key -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null gpdb_src/gpAux/extensions/gps3ext/gps3ext.so gpadmin@$EC2_INSTANCE_IP:/home/gpadmin/greenplum-db/lib/postgresql/
